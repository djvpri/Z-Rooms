...
minta /api/log '307' 'endpoint log error kasir'
minta /api/kamar           '307'      'middleware lindungi sebelum route'
minta /api/booking         '307'      'middleware lindungi sebelum route'
minta /api/karaoke/ruang   '307'      'daftar ruang karaoke'
minta /api/karaoke/tarif   '307'      'tarif karaoke'
minta /api/karaoke/sesi    '307'      'sesi karaoke (buka/daftar)'
minta /api/karaoke/laporan '307'      'laporan pendapatan karaoke'
